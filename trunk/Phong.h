...
public:
	...
	Phong(Color* _od) : ia(1.0), oa(new Color((*_od) * ia)), od(_od), os(new Color(1.0, 1.0, 1.0)), ka(1.0), kd(0.7), ks(0.3), n(10) {}
	Phong(Color* _oa, Color* _od, Color* _os, double _ia, double _ka, double _kd, double _ks, int _n) : oa(_oa), od(_od), os(_os), ia(_ia), ka(_ka), kd(_kd), ks(_ks), n (_n) {}
