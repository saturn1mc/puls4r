...
public class Perlin {
	...
	static private double fade(double t) {
	...
	static private double grad(int hash, double x, double y, double z) {
	...
	public void disruptNormal(Vector3d n, double e) {
		double x, y, z;
